...
function CreateTrip() {
  ...
  // useEffect(() => {
  //   console.log(formData) // Removed console.log
  // }, [formData])
  ...
  const onGenerateTrip = async () => {
    ...
    // console.log(FINAL_PROMPT) // Removed console.log

    const result = await chatSession.sendMessage(FINAL_PROMPT);
    // console.log(result?.response?.text()); // Removed console.log
    setLoading(false);
  ...
  const login = useGoogleLogin({
    ...
    onError: (error) => console.error("Login failed:", error) // Changed to console.error
  })
